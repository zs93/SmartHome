...
/* SW_6 is at P0.1 */ //IO口设置
#define HAL_KEY_SW_6_PORT   P0
#define HAL_KEY_SW_6_BIT    BV(1)//BV(4)sw_6按键在p0.4
#define HAL_KEY_SW_6_SEL    P0SEL
#define HAL_KEY_SW_6_DIR    P0DIR

/* edge interrupt */
#define HAL_KEY_SW_6_EDGEBIT  BV(0)
#define HAL_KEY_SW_6_EDGE     HAL_KEY_FALLING_EDGE//HAL_KEY_RISING_EDGE上升沿触发
...
#define HAL_KEY_SW_6_ICTLBIT  BV(1) /* P0IEN - P0.1 enable/disable bit */ //中断标志位BV(4)
...
void HalKeyPoll (void)
{
  ...
  {
    //keys = halGetJoyKeyInput();//不需要用到遥感
  }
